...
public class AttendanceActivity extends AppCompatActivity {
    @BindView(R.id.image_attandance)
    ImageView image_attandance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tool_bar_title.setText("Attandence");
       // showImage();
    }
    ...
    private void showImage()
    {
        ...
        if (st.getImg_images() != null && st.getImg_images().trim().length() > 0) {
            image_attandance.setVisibility(View.VISIBLE);
            Picasso.with(this)
                    ...
                    .into(image_attandance);
        } else {
            image_attandance.setVisibility(View.GONE);
        }
    }
}
