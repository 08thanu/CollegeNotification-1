...
import com.example.admin.collegenoti.interfaces.OnDateSetInterface;
...
public class P {
    ...
    public static String URL = "http://192.168.1.11:81/clg_noti/index.php/";
    public static final Object IMAGE_URL = "http://192.168.1.11:81/clg_noti/./Images/";
    ...
    public static void saveUserLoginData(Context context, User u) {
        ...
        editor.putString("user_mobile_number", u.user_mobile_number);
        editor.putString("user_username", u.user_username);
        editor.putString("user_sem", u.user_sem);
        editor.putString("user_type", u.user_type);
        editor.putString("user_urn", u.user_urn);
        editor.apply();
    }
    ...
    public static User getUserDetails(Context context) {
        ...
        u.user_mobile_number = prefs.getString("user_mobile_number", null);
        u.user_username = prefs.getString("user_username", null);
        u.user_sem = prefs.getString("user_sem", null);
        u.user_type = prefs.getString("user_type", null);
        u.user_urn = prefs.getString("user_urn", null);
    ...
    public static void userLogout(Context context) {
        ...
        editor.putString("user_sem", null);
        editor.putString("user_type", null);
        editor.putString("user_urn", null);
        editor.clear();
        editor.commit();
    }
